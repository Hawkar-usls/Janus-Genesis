...
Genesis v18.7.4 carries imperfect source bytes through valid lossless origin
_envelope JSON documents rather than treating a filename suffix as proof that
arbitrary source bytes are valid JSON.
"""
